		...
		<div class="modal-content">
			<div class="container p-3 border">
				...
				<c:if test="${empty changedPwdYN || 'N' == changedPwdYN}">
					<form name="changPwdForm" method="post" action="${ctxPath}/memberPwdChangeOk.mbr" class="was-validated">
						<h2>비 밀 번 호  재 설 정</h2>
						<c:choose>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="email" placeholder="새비밀번호를 입력하세요." required />
							<div class="valid-feedback"></div>
							<div class="invalid-feedback">새비밀번호는 필수 입력사항입니다.</div>
						</div>
						<div class="form-group">
							<label for="rePwd">새비밀번호 확인 : </label>
							<input type="text" class="form-control" name="email" placeholder="새비밀번호를 다시 입력하세요." required />
							<div class="valid-feedback"></div>
