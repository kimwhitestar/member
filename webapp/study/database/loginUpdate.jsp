...
<div class="container text-center">
  <form name="myForm" method="post" action="${ctxPath}/loginUpdateOk">
  	<table class="table table-bordered text-center">
  	  <tr>
  	    <td colspan="2"><h3>회 원 정 보 수 정</h3></td>
  	  </tr>
  	  <tr>
  	  	<th class="bg-secondary text-white">아이디</th>
  	  	<td><input type="text" name="mid" value="${vo.mid}" autofocus class="form-control" disabled /></td>
  	  </tr>
  	  <tr>
  	  	<th class="bg-secondary text-white">비밀번호</th>
  	  	<td><input type="password" name="pwd" value="${vo.pwd}" value="1234" class="form-control"/></td>
  	  </tr>
  	  <tr>
  	  	<th class="bg-secondary text-white">이름</th>
  	  	<td><input type="text" name="name" value="${vo.name}" value="김말숙" class="form-control"/></td>
  	  </tr>
  	  <tr>
  	    <td colspan="2">
